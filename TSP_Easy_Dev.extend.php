<?php				
     ...
     * @copyright 2015 Let A Pro Do IT!
        ...
        public function display_widget( $fields, $echo = true, $tag = null )
        {
            ...
            if (!empty ( $queried_posts ))
            {
                ...
                foreach ( $queried_posts as $this_post )
                {
                    ...
                    if (!empty($pro_post))
                        $media = $pro_post->get_post_media ( $this_post, $fields['thumb_width'], $fields['thumb_height'] );
                    ...
                    if ( $fields['show_text_posts'] == 'Y' || ( $fields['show_text_posts'] == 'N' && !empty( $media ) ) )
                    {
                        ...
                        $words          = explode(' ', $fields['title'], $fields['max_words'] + 1);
                        ...
                        $smarty->assign("show_thumb", 				($fields['show_thumb'] == 'Y') ? true : null, true);
                        $return_HTML .= $smarty->fetch( $this->options->get_value('name') . '_layout'.$fields['layout'].'.tpl' );
                    }
                } //endforeach;
            }//end if
            else{
                $return_HTML .= $fields['no_posts_msg'];
            }//end if
